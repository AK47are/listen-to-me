...
@Service
public class CreatorApplyServiceImpl extends ServiceImpl<CreatorApplyMapper, CreatorApply>
        implements CreatorApplyService {
    ...
    @Override
    public CreatorApplyVO findApplyStatus(Long userId) {
        CreatorApply creatorApply = getOne(Wrappers.lambdaQuery(CreatorApply.class)
                .eq(CreatorApply::getUserId, userId));
        if (creatorApply == null) {
